...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('asignaciones_especiales', function (Blueprint $table) {
            $table->increments('id');
            $table->unsignedInteger('unidad_id')->index('asignaciones_especiales_unidad_id_foreign');
            $table->unsignedInteger('user_id')->index('asignaciones_especiales_user_id_foreign');
            $table->date('fecha');
            $table->unsignedInteger('gasolinera_id')->index('asignaciones_especiales_gasolinera_id_foreign');
    ...
    {
        Schema::dropIfExists('asignaciones_especiales');
    }
};
